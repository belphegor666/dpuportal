...
const $$dataType = {
    ...
    /** UK Phone Number - Allows [Any Number Of Spaces][Zero or One +][Any Digit, Whitespace, Dash or Bracket][At least one digit][Any Digit, Whitespace, Dash or Bracket]*/
    TELEPHONE: /^\s*[+]{0,1}[0-9\s-()]*[0-9]+[0-9\s-()]*$/,
