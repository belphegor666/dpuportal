...
object Lib {
  ...
  val mailer        = "com.typesafe.play"           %   "play-mailer_2.11"        % Version.MAILER
  val commons_lang  = "commons-lang"                %   "commons-lang"            % Version.COMMONS_LANG
  val jwt           = "io.jsonwebtoken"             %   "jjwt"                    % Version.JWT
  val mockito       = "org.mockito"                 %   "mockito-core"            % Version.MOCKITO
  val ical4j        = "org.mnode.ical4j"            %   "ical4j"                  % Version.ICAL4J
  val dumbster      = "com.bitmechanic"             %   "dumbster"                % Version.DUMBSTER
}
